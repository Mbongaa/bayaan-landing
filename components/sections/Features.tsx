...
export function Features() {
  ...
  const dashboardTabs = [
    { id: 'overview', label: 'Overview', icon: BarChart3, screenshot: '/screenshots/OverviewLight.png' },
    { id: 'rooms', label: 'Room Management', icon: Radio, screenshot: '/screenshots/AdminViewLight.png' },
    { id: 'sessions', label: 'Session History', icon: History, screenshot: '/screenshots/SessionHistoryLight.png' },
    { id: 'analytics', label: 'Analytics', icon: BarChart3, screenshot: null }, // Placeholder for 4th screenshot
  ]
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
            Complete control and insights for your mosque&apos;s translation system with advanced analytics and management tools.
          </p>
        </motion.div>
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            >
              Experience the intuitive dashboard interface designed for mosque administrators
            </motion.p>
          </div>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 md:gap-8 text-center">
            <div>
              ...
              <div className="text-sm md:text-base text-cream-100">Transcription Languages</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold mb-1 md:mb-2">∞</div>
              <div className="text-sm md:text-base text-cream-100">Translation Languages</div>
            </div>
            <div>
